...
|*name* +
_required_|Command line option (exactly as it is passed to the ODM process, minus the leading '–')|string
|*type* +
...
==== Description
Retrieves an asset (the output of ODM processing) associated with a task
...
==== Description
Retrieves the console output of the ODM process. Useful for monitoring execution and to provide updates to the user.
