...
AppId={{443998BA-9F8F-4A69-9A96-0D8FBC8C6394}
AppName={#MyAppName}
...
DefaultDirName=C:\ODX
DefaultGroupName={#MyAppName}
AllowNoIcons=yes
LicenseFile=LICENSE
OutputDir=dist
OutputBaseFilename=ODX_Setup_{#MyAppVersion}
Compression=lzma
...
[Dirs]
Name: "{commonappdata}\ODX"; Permissions: users-modify

[Icons]
Name: {group}\ODX Console; Filename: "{app}\console.bat"; WorkingDir: "{app}"
Name: "{userdesktop}\ODX Console"; Filename: "{app}\console.bat"; WorkingDir: "{app}"; Tasks: desktopicon
...
Filename: "{app}\console.bat"; Description: {cm:LaunchProgram,ODX Console}; Flags: nowait postinstall skipifsilent
